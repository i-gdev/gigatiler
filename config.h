...
static const int usealtbar               = 1;        /* 1 means use non-gigatiler status bar */
...
/* Tags
 * In a traditional gigatiler the number of tags in use can be changed simply by changing the number
 * of strings in the tags array. This build does things a bit different which has some added
 * benefits. If you need to change the number of tags here then change the NUMTAGS macro in gigatiler.c.
 *
 * Examples:
 *
...
static const Rule rules[] = {
	...
	RULE(.class = "pcmanfm-qt", .isfloating = 1)
	RULE(.class = "Gimp", .tags = 1 << 4)
	RULE(.class = "Firefox", .tags = 1 << 7)
...
/* helper for spawning shell commands in the pre gigatiler-5.0 fashion */
...
static const char *ipcsockpath = "/tmp/gigatiler.sock";
